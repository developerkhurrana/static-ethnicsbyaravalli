        ...
        <div className="relative z-10 text-center px-4 py-24 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Button asChild size="lg" className="bg-green-500 hover:bg-green-600 text-white text-lg px-8 py-3 flex items-center gap-2">
              <Link href="https://wa.me/919828422208?text=Hi, I&apos;m interested in bulk ethnic wear supply. Please share your Navratri 2025 catalog.">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="https://wa.me/919828422208?text=Hi, I&apos;m interested in bulk ethnic wear supply. Please share your Navratri 2025 catalog.">WhatsApp Us</Link>
            </Button>
          </div>
        </div>
      </section>
