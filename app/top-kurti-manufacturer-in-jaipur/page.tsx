    ...
    <div className="bg-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-20 flex flex-col items-center text-center px-4 py-24">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg mb-4">Top Kurti Manufacturer in Jaipur</h1>
          <p className="text-lg md:text-2xl text-white/90 mb-8 max-w-2xl">Premium, boutique-ready kurtis crafted with care. Trusted by 300+ retailers for quality, style, and service.</p>
